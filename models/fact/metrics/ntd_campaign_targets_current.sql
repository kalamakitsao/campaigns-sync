...
aggregated AS (
    SELECT
        ...
        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign BETWEEN 24 AND 107) AS count_total_2years_to_8years,
        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign BETWEEN 24 AND 107 AND pwa.sex = 'male') AS count_total_2years_to_8years_male,
        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign BETWEEN 24 AND 107 AND pwa.sex = 'female') AS count_total_2years_to_8years_female,

        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign BETWEEN 108 AND 167) AS count_total_5years_to_13years,
        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign BETWEEN 108 AND 167 AND pwa.sex = 'male') AS count_total_5years_to_13years_male,
        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign BETWEEN 108 AND 167 AND pwa.sex = 'female') AS count_total_5years_to_13years_female,

        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign > 168) AS count_total_over_14_years,
        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign > 168 AND pwa.sex = 'male') AS count_total_over_14_years_male,
        COUNT(pwa.uuid) FILTER (WHERE age_in_months_at_campaign > 168 AND pwa.sex = 'female') AS count_total_over_14_years_female
